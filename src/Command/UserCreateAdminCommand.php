...
class UserCreateAdminCommand extends Command
{
    ...
    private static $security_password_command;
    /**
    ...
    public function __construct(EntityManagerInterface $entityManager, UserPasswordEncoderInterface $passwordEncoderstring, EncoderFactoryInterface $encoderFactory, ConsoleSecurityConfig $config)
    {
        self::$security_password_command = $config->getPassword();
